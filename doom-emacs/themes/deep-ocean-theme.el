;;; deep-ocean-theme.el - based on https://material-theme.com/docs/configuration/color-schemes/ -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup deep-ocean nil
  "Options for the `deep-ocean' theme."
  :group 'doom-themes)

(defcustom deep-ocean-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'deep-ocean
  :type 'boolean)

(defcustom deep-ocean-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'deep-ocean
  :type 'boolean)

(defcustom deep-ocean-colorful-headers nil
  "If non-nil, headers in org-mode will be more colorful; which is truer to the
original Dracula Emacs theme."
  :group 'deep-ocean
  :type 'boolean)

(defcustom deep-ocean-comment-bg deep-ocean-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'deep-ocean
  :type 'boolean)

(defcustom deep-ocean-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme deep-ocean
  "A dark theme based on Deep Ocean theme"

  ;; name        default   256       16
  ((bg         '("#0f111a" "#292D3E" "black"        ))
   (bg-alt     '("#0f111a" "#1c1c1c" "black"        ))
   (base0      '("#0f111a" "#1c1c1c" "black"        ))
   (base1      '("#0f111a" "#1e1e1e" "brightblack"  ))
   (base2      '("#373844" "#2e2e2e" "brightblack"  ))
   (base3      '("#44475a" "#292D3E" "brightblack"  ))
   ...
   (selection      dark-blue)
   (builtin        orange)
   (comments       (if deep-ocean-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if deep-ocean-brighter-comments dark-cyan base5) 0.25))
   (constants      cyan)
   (functions      green)
   (keywords       magenta)
   (methods        teal)
   ...
   (level1 magenta)
   (level2 violet)
   (level3 (if deep-ocean-colorful-headers green   (doom-lighten violet 0.35)))
   (level4 (if deep-ocean-colorful-headers yellow  (doom-lighten magenta 0.35)))
   (level5 (if deep-ocean-colorful-headers cyan    (doom-lighten violet 0.6)))
   (level6 (if deep-ocean-colorful-headers orange  (doom-lighten magenta 0.6)))
   (level7 (if deep-ocean-colorful-headers blue    (doom-lighten violet 0.85)))
   (level8 (if deep-ocean-colorful-headers magenta (doom-lighten magenta 0.85)))
   (level9 (if deep-ocean-colorful-headers violet  (doom-lighten violet 0.95)))

   (-modeline-bright deep-ocean-brighter-modeline)
   (-modeline-pad
    (when deep-ocean-padded-modeline
      (if (integerp deep-ocean-padded-modeline) deep-ocean-padded-modeline 4)))
  ...
  (((line-number &override) :foreground base5)
   ...
   ((font-lock-comment-face &override)
    :background (if deep-ocean-comment-bg (doom-lighten bg 0.05)))
   (mode-line
