...
_G.packer_plugins = {
  ...
  ["noice.nvim"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/noice.nvim",
  ...
  ["nvim-nu"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/nvim-nu",
  ...
  ["yuck.vim"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/yuck.vim",
